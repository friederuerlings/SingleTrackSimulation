...
resultVarsVektor = ["distance"; "velocity"; "a_x"; "a_y"; "radius"; "drs_open"; "F_x_Front"; "F_z_Front"; "yawspeed"];
...
set_param('segmentCalc','StartTime','0','StopTime','inf','SolverType','Fixed-step','FixedStep','1e-3');
% set_param('segmentCalc','StartTime','0','StopTime','inf','SolverType','Variable-step','MinStep','auto','MaxStep','1e-3');
